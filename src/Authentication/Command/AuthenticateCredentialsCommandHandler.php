...
class AuthenticateCredentialsCommandHandler
{
    ...
    {
        $authenticators = app('streams.extensions')->getAll('module.users::authenticator');
     ...
     * @return null
     */
    protected function attemptAuthentication(AuthenticatorExtension $authenticator, $credentials)
    {
